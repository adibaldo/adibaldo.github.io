# 🗒️ Roteiro de Prosa: seu Adi

Este arquivo é o mapa das nossas próximas conversas. Ele deve ser atualizado sempre que a tropa (Jules) trouxer algo novo ou quando o Franklin der uma sugestão.

---

## 🧉 Assuntos para a Próxima Prosa
- [x] **O Causo do Teco-Teco:** Comentar que o texto foi polido e o Getúlio Vargas agora faz parte da "aerodinâmica bovina". (Rastro: [PR #43](https://github.com/franklinbaldo/aparicio-funes/pull/43))
- [x] **Ajuste de Imagem:** Reverter a imagem do Vovô Franquelim para a versão original que o seu Adi gostava.
- [x] **Estilo Rústico:** Transformar o visual do "Balcão de Prosas" em algo mais rústico, tipo "tábua lascada".
- [x] **Conjunto da Obra:** Facilitar a visualização de todos os textos no blog.
...
- **Livro de Memórias:** Continuar colhendo detalhes sensoriais da infância e da chegada em Rondônia.
- **Ecos do Pampa:** Minha nova coluna onde vamos resgatar a história de São Borja.
